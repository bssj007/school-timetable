            ...
            {isTeacherPage ? (
              ...
              <div className="flex items-center">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="lg:hidden h-8 px-2 font-bold text-xs text-emerald-700 hover:bg-emerald-50/80 hover:text-emerald-800 flex items-center gap-1 rounded-lg border-none shadow-none cursor-pointer select-none ml-2.5"
              ...
              {isBugReportEnabled && (
                <>
                  <Button
                    ...
                    size="sm"
                    className={`lg:hidden h-9 px-2.5 font-bold text-xs ${
                      isTeacherPage
                        ? "border-none shadow-none rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100/70 font-medium"
                  ...
                  {/* 모바일 전용 희미한 칸막이 */}
                  {isTeacherPage && (
                    <div className="lg:hidden h-3.5 w-[1px] bg-gray-200 mx-0.5" />
                  )}
                </>
              )}
