      ...
      <div className="flex items-stretch gap-2 md:hidden mb-3">
        ...
        <div className="flex flex-col justify-between gap-0.5 w-[130px] shrink-0">
          <div className="flex items-center gap-1 bg-gray-100 rounded-full p-0.5">
            <div className="flex-1 flex items-center justify-center px-2 py-1 text-xs font-semibold rounded-full bg-white text-gray-800 shadow-sm whitespace-nowrap">
              시간표
            </div>
            <a
              href="/meal"
              className="flex-1 flex items-center justify-center px-2 py-1 text-xs font-semibold rounded-full text-gray-500 hover:text-orange-500 hover:bg-white/60 transition-all whitespace-nowrap"
            >
              급식표
            </a>
          </div>
