...
export default function IOSInstallGuide() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex flex-col overflow-hidden">
      ...
      {/* 하단 확인 버튼 */}
      <div
        className="flex-shrink-0 bg-white border-t border-gray-100 px-6 pt-4"
        style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 16px)" }}
      >
        <button
          onClick={() => setLocation("/")}
          className="w-full py-4 rounded-2xl bg-black text-white text-base font-extrabold active:bg-gray-800 transition-colors"
        >
          확인
        </button>
      </div>
